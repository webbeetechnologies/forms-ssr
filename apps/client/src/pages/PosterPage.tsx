      ...
      <Form>
        ...
        <div style={{ 
          ...
          <div style={{ background: 'white', padding: '20px', borderRadius: '12px', border: '1px solid #eee' }}>
            ...
            <PhoneInput id="phone" defaultCountry="US" placeholder="+1 555 123 4567" />
          </div>

          <div style={{ background: 'white', padding: '20px', borderRadius: '12px', border: '1px solid #eee' }}>
            <Title>Details</Title>
            <NumberInput id="exp" placeholder="Years of experience" />
            <div style={{ marginTop: '10px' }} />
            <DateInput id="date" />
          </div>
          ...
          <div style={{ background: 'white', padding: '20px', borderRadius: '12px', border: '1px solid #eee' }}>
            ...
            <TextArea id="why" placeholder="Why do you want to work with us?" />
          </div>
