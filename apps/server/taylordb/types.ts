...
export const Table1StatusOptions = ['Progress', 'Done', 'Trash'] as const;
...
type Table1Table = {
  ...
  status: SingleSelectColumnType<typeof Table1StatusOptions, false>;
...
type CandidatesTable = {
  ...
  searchText: SearchColumnType;
  name: TextColumnType<false>;
  email: TextColumnType<false>;
  phone: TextColumnType<false>;
